...
class IsSignInWithEmailLink extends UseCases<bool, Map<String, dynamic>> {
  final UserRepository repository;

  IsSignInWithEmailLink({required this.repository});
  @override
  Future<Either<String, bool>> call(Map<String, dynamic> params) async {
    return await repository.isSignInWithEmailLink(params);
  }
}
